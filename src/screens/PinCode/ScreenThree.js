    ...
    return (
        <View style={styles.main}>
            <View style={styles.heading}>
                ...
                }}>Most trustworthy app ever</Text>
            </View>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 110, paddingHorizontal: 20 }}>
                ...
                <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <TouchableOpacity onPress={()=> {navigation.navigate("ScreenFour")}} style={{ backgroundColor: '#F5A20D', justifyContent: 'center', alignItems: 'center', width: 175, height: 40, borderRadius: 30, marginTop: 70 }}>
